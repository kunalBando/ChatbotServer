...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://nice-sky-08aa0150f.4.azurestaticapps.net', 'https://victorious-ocean-0f5d4ab10.4.azurestaticapps.net', 'http://localhost:5173');
